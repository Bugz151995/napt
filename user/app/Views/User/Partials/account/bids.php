<label for="bids-list" class="fs-5 mb-5"><i class="bx bx-tag-alt bx-fw"></i>My Bids</label>

<?php if($bids) : ?>

  <section id="bids-list" class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-3">

    <?php foreach ($bids as $key => $lot) : ?>
  ...
  <div class="alert alert-dismissible shadow-sm rounded animate__animated animate__bounceInLeft animated__faster">
    <div class="d-flex gap-3">
      ...
      <div id="message">
        ...
        <p>It seems like you don't have bids yet.</p>
      </div>
