<div id="sidebar" class="d-flex flex-column text-dark bg-light shadow">
  ...
  <ul class="p-3 nav nav-pills flex-column flex-nowrap h-100">
    <li>
      <a href="<?= base_url() ?>/admin/auction" class="nav-link small <?= (end($page) === 'auction') ? 'active' : null ?>">
    ...
    <li>
      <a href="<?= base_url() ?>/admin/users" class="nav-link small <?= (end($page) === 'users') ? 'active' : null ?>">
        <i class="bx bx-chevron-right bx-fw"></i>
